...
const generationLoadingMessages = [
  "Menghubungi studio AI...",
  "Membangun model baru sesuai deskripsi...",
  "Menerapkan pencahayaan dan suasana...",
  "Menyelesaikan sentuhan akhir... Hampir selesai!",
];
...
const App: React.FC = () => {
  ...
  const anyLoading = isLoading || isRandomizingModel || isRandomizingScene || isAdaptingScene || isRandomizingOutfit || isRandomizingPose || isRandomizingDescription;
  const selectedImage = generatedImages ? generatedImages[selectedImageIndex] : null;
